...
# Read isotope data
list_files <- dir(path = "raw_data/traits/IsotopeData/", pattern = "\\.xlsx$", full.names = TRUE)
...
# cnp_data_drone <- CorrectedValues %>%
...
#   left_join(cnp_data_drone, by = "ID") %>%
