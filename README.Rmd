...
Gradient_Diversity_Figure(diverstiy_gradient)
...
traits_gradient <- read_csv(file = "clean_data/traits/PFTC4_Svalbard_2018_Traits_Gradients.csv")

Gradient_Trait_Figure(traits_gradient)
